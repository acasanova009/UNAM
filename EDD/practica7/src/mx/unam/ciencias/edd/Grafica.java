...
public class Grafica<T> implements Iterable<T> {
    ...
    private class Vertice<T> implements VerticeGrafica<T> {
        ...
        private boolean esVisible()
        {
            ...
            if(this.color == Color.VISIBLE ||this.color == Color.NEGRO  )
                esVisible = true;
            return esVisible;
        }
...
//
//        
//        VerticeGrafica<T> vE =vertice(elemento);
//        
////        vE.setColor(Color.NEGRO);
////        accion.actua(vE);
//        
//        
//        
//        dfs_r(vE,accion, new Lista<T>());
//        
//        for(Vertice<T> vA :vertices)
//            vA.setColor(Color.NINGUNO);
//    }
//    private void dfs_r(VerticeGrafica<T> vA, AccionVerticeGrafica<T> accion ,Lista<T> lis )
//    {
//        
//        
//        
//        accion.actua(vA);
//        lis.agregaFinal(vA.getElemento());
//        System.out.println("---Rpresentacion de como va quedando mi dfs--->\n"+lis);
////
//        Vertice<T> vE =cVertice(vA);
//                        System.out.println("---Grafica, el simbolo @ significa que ya fue visitado--->\n"+this);
//
////
//        vA.setColor(Color.NEGRO);
//        for(VerticeGrafica<T> vG: vA)
//        {
//
//            if(vG.getColor() != Color.NEGRO)
//            {
//                dfs_r(vG, accion, lis);
//            }
//            
