...
//     */
    ...
    /**
     * Prueba unitaria para {@link
     * FabricaHuellasDigitales#getInstanciaString} con una huella
     * digital inválida.
     */
    @Test public void testGetInstanciaStringInvalida() {
        try {
            HuellaDigital<String> bj =
                FabricaHuellasDigitales.getInstanciaString(1000);
            Assert.fail();
