...
public interface IteradorLista<T> extends Iterator<T> {
     ...
     * de llamar este método, el método {@link Iterator#hasNext}
     * siempre regresa <tt>true</tt> si la lista no es vacía.
     */
    public void start();

    /**
     * Mueve el iterador a la derecha del último elemento. Después
     * de llamar este método, el método {@link
     * IteradorLista#hasPrevious} siempre regresa <tt>true</tt> si
