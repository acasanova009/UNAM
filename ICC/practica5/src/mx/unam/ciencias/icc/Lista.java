...
public class Lista <id> {
    ...
    public void agregaFinal(id elemento) {
        Nodo<id> n = new Nodo<id>(elemento);
    ...
    private void iterarElimina(Nodo<id> t, id elemento){
        if (t==null)
            return;
    ...
    private boolean iterarContiene(Nodo<id> t, id elemento){
        if (t==null)
            return false;
        if(t.elemento.equals(elemento))
            return true;
    ...
    public Lista<id> reversa() {
        return iterarReversa(cabeza,new Lista<id>());
    }
    private Lista<id> iterarReversa(Nodo<id> t, Lista<id> lista){
        if (t==null)
            return lista;
    ...
    public Lista<id> copia() {
        return iterarCopia(cabeza,new Lista<id>());
    }
    private Lista<id> iterarCopia(Nodo<id> t, Lista<id> lista){
        if (t==null)
            return lista;
    ...
    private id iterarGet(int i,int c, Nodo<id> t){
        if (c < i)
    ...
    private int iterarInidiceDe(Nodo<id> t,id elemento,int c)
    {
        if (t== null)
            return -1;
        if(t.elemento.equals(elemento))
    ...
    private String iterarToString(Nodo<id> t,String s)
    {
