...
/**
 * Práctica 7: Excepciones y entrada/salida.
 */
public class Practica7 {
    ...
    private static void busquedas(BaseDeDatosEstudiantes bdd) {
        ...
        if (r.getLongitud() == 0) {
            System.out.printf("\nNo se hallaron estudiantes con el nombre \"%s\".\n",
                              nombre);
        } else {
            r.primero();
            System.out.printf("\nSe hallaron los siguientes estudiantes con el nombre \"%s\":\n\n",
                              nombre);
            while (r.iteradorValido()) {
                System.out.println(r.dame() + "\n");
                r.siguiente();
            }
        }
        ...
        if (r.getLongitud() == 0) {
            System.out.printf("\nNo se hallaron estudiantes con la cuenta \"%d\".\n",
                              cuenta);
        } else {
            r.primero();
